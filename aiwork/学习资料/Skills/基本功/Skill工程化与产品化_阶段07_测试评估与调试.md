...
### Added
- Added negative examples for casual summary requests.
- Added missing-input handling for insufficient source content.

### Changed
- Refined description to include Chinese trigger terms: 沉淀, 知识库, .md.

### Fixed
- Prevented conversational phrases such as “你的问题” from appearing in final output.
```
